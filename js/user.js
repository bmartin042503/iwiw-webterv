...
const users = [
    new User(0, "Nagy Béla", "1999/05/25", "bela@example.com", 456, "../img/static/users/user-1.png"),
    new User(1, "Kovács Anna", "1998/02/14", "anna@example.com", 102, "../img/static/default-profile.png"),
    new User(0, "Szabó Peti", "2001/11/08", "peter@example.com", 34, "../img/static/users/user-2.png"),
    ...
    new User(0, "Kertész Kolompár", "2002/03/27", "andras@example.com", 432, "../img/static/users/user-6.png"),
    ...
    new User(0, "Molnár Zsolt", "1997/01/09", "zsolt@example.com", 156, "../img/static/users/user-9.png"),
    new User(0, "Kovács József", "2000/10/02", "istvan@example.com", 347, "../img/static/users/user-10.png")
];
